...
CFLAGS	=  `$(PREFIX)pkg-config --cflags sdl2` -g -O3 -mrvl -mcpu=750 -Wall $(MACHDEP) $(INCLUDE) -DHW_RVL -DUSE_WIIDRC
CXXFLAGS	=	$(CFLAGS)
...
#---------------------------------------------------------------------------------
LIBS	:=	`$(PREFIX)pkg-config --libs sdl2` -lfat -lwiiuse -lbte -logc -lm -lopus
